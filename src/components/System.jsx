...
const System = () => {
    ...
    const retornoapi = async () => {
        const responseInfos = await axios.post('https://meu-projeto-back-end-production.up.railway.app/connectionAPI.php', {
            'content': '',
    ...
    const retornoClass = async () => {
        trackPromise(retornoapi().then(async () => {
            const infoPie = await axios.post('https://meu-projeto-back-end-production.up.railway.app/connectionAPI.php', {
                'content': '',
                'function': 'getPie'
            });
            ...
            const infoLine = await axios.post('https://meu-projeto-back-end-production.up.railway.app/connectionAPI.php', {
                'content': '',
                'function': 'getLine'
            });
            ...
            const infoBar = await axios.post('https://meu-projeto-back-end-production.up.railway.app/connectionAPI.php', {
                'content': '',
                'function': 'getBar'
            });
    ...
    const getData = async (event) => {
        ...
        const response = await trackPromise(axios.post('https://meu-projeto-back-end-production.up.railway.app/connectionAPI.php', {
